...
killall traffic_scroller.sh 2>/dev/null
...
# Start Smooth Scroller (Throttles the log for display)
/home/g0dmax55/Desktop/conky/g0dmax55-conky/scripts/traffic_scroller.sh &
