...
echo "\${execgraph /home/g0dmax55/Desktop/conky/g0dmax55-conky/scripts/ssh_remote_rx.sh 35,400 440000 FF0000 -l -t}"
echo "\${voffset 3}"
...
echo "\${execgraph /home/g0dmax55/Desktop/conky/g0dmax55-conky/scripts/ssh_remote_tx.sh 35,400 440000 FF0000 -l -t}"
